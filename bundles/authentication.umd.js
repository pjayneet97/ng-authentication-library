(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/fire/auth'), require('firebase/app'), require('firebase'), require('@angular/fire'), require('@angular/common'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('authentication', ['exports', '@angular/core', '@angular/fire/auth', 'firebase/app', 'firebase', '@angular/fire', '@angular/common', '@angular/forms'], factory) :
    (global = global || self, factory(global.authentication = {}, global.ng.core, global.ng.fire.auth, global.app, global.firebase, global.ng.fire, global.ng.common, global.ng.forms));
}(this, (function (exports, core, auth, app, firebase, fire, common, forms) { 'use strict';
    ...
    var AuthenticationService = /** @class */ (function () {
        ...
        /** @nocollapse */ AuthenticationService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function AuthenticationService_Factory() { return new AuthenticationService(core.ɵɵinject(auth.AngularFireAuth)); }, token: AuthenticationService, providedIn: "root" });
    ...
    var AuthenticationModule = /** @class */ (function () {
        ...
        AuthenticationModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            fire.AngularFireModule.initializeApp({
